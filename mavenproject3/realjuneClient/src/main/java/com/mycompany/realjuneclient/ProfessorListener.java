 ...
 */
package com.mycompany.realjuneclient;
...
public class ProfessorListener implements MessageListener {
    ...
    public void onMessage(Message msg) {
        try {
            ...
            com.mycompany.realjunejmsserver.ExamImplService service = new com.mycompany.realjunejmsserver.ExamImplService();
            com.mycompany.realjunejmsserver.Exam port = service.getExamImplPort();
            com.mycompany.realjunejmsserver.Professor result = port.getDetails(id);
