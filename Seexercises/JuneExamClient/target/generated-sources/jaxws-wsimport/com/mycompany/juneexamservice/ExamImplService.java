 ...
 * 
 */
@WebServiceClient(name = "ExamImplService", targetNamespace = "http://juneexamservice.mycompany.com/", wsdlLocation = "http://localhost:8080/JuneExamService/ExamImplService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EXAMIMPLSERVICE_QNAME = new QName("http://juneexamservice.mycompany.com/", "ExamImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/JuneExamService/ExamImplService?wsdl");
    ...
    public Exam getExamImplPort() {
        return super.getPort(new QName("http://juneexamservice.mycompany.com/", "ExamImplPort"), Exam.class);
    }
    ...
    public Exam getExamImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://juneexamservice.mycompany.com/", "ExamImplPort"), Exam.class, features);
    }
