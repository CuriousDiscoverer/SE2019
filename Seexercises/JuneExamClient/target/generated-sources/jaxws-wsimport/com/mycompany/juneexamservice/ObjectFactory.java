 ...
 * generated in the com.mycompany.juneexamservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetMovieResponse_QNAME = new QName("http://juneexamservice.mycompany.com/", "getMovieResponse");
    private final static QName _GetMovies_QNAME = new QName("http://juneexamservice.mycompany.com/", "getMovies");
    private final static QName _GetMoviesResponse_QNAME = new QName("http://juneexamservice.mycompany.com/", "getMoviesResponse");
    private final static QName _Movie_QNAME = new QName("http://juneexamservice.mycompany.com/", "movie");
    private final static QName _Director_QNAME = new QName("http://juneexamservice.mycompany.com/", "director");
    private final static QName _GetDirector_QNAME = new QName("http://juneexamservice.mycompany.com/", "getDirector");
    private final static QName _GetMovie_QNAME = new QName("http://juneexamservice.mycompany.com/", "getMovie");
    private final static QName _GetDirectorResponse_QNAME = new QName("http://juneexamservice.mycompany.com/", "getDirectorResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.mycompany.juneexamservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "getMovieResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "getMovies")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "getMoviesResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "movie")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "director")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "getDirector")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "getMovie")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://juneexamservice.mycompany.com/", name = "getDirectorResponse")
