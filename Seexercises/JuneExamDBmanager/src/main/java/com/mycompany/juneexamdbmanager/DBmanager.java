 ...
 */
package com.mycompany.juneexamdbmanager;
...
public class DBmanager {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        try {
            //This create the file of the database in the selected position
            connection = DriverManager.getConnection("jdbc:sqlite:/home/biar/se-june-exam.db");
