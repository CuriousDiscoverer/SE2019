...
import com.mycompany.firstrest.DiscountCode;
 ...
 */
@Stateless
@Path("com.mycompany.firstrest.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {

    @PersistenceContext(unitName = "com.mycompany_01-FirstRest_war_1.0-SNAPSHOTPU")
